...
if __name__ == "__main__":
    ...
    # Run example
    analyzer = example_california_wildfire_area()
    
    # Or analyze custom location:
    # analyzer = example_custom_location(lon=-118.6, lat=34.1, buffer_km=10)
    
    print("\nAnalysis complete!")
    print("Check the generated files:")
    print("  - fire_risk_map.html (interactive map)")
    print("  - fire_risk_analysis_gee.png (static visualization)")
